...
public class week3 {
	...
	// Veronica Padon
	// Coding Assignment Week3-4
	// Promineo Teech Software Dev
...
//				 int nameLengths[] = new int[names.length];
		...
		//10. take a double array, return avg of all elements in array
			...
			System.out.println("Average in the array "+"is "+Average(dbArray)); //39/7 =  average 5.57142...
		...
		//12. if moneyInPocket > 10.50 and isHotOutside = true, return true 
